...
export default function CTAExample(): React.JSX.Element {
  return (
    <>
      <nav>
          ...
          <li className="example-li">
            ...
            <div className="example-megamenu">
              <ReactMegaMenu menus={menu} options={{
                CTA: {
                  title: "Our Brands", description: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Accusantium, deleniti.",
